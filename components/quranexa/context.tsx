...
export function Provider({locale,children}:{locale:Locale;user?:boolean;children:ReactNode}){
  ...
  const d=useMemo(()=>({...raw,
    ...
    loginToSave:locale==='ur'?'تمام آلات پر ہم آہنگی کے لیے داخل ہوں':locale==='ar'?'سجل الدخول للمزامنة عبر أجهزتك':'Sign in to sync across devices',
    ...
    accountNote:locale==='ur'?'آپ کا Quran - Exa کھاتا آپ کی ترجیحات، محفوظ آیات، مطالعے کی تاریخ اور گفتگو ہم آہنگ کرتا ہے۔':locale==='ar'?'يزامن حساب Quran - Exa تفضيلاتك ومحفوظاتك وسجل القراءة والمحادثات.':'Your Quran - Exa account syncs preferences, bookmarks, reading history and chats.',
    ceoRole:locale==='ur'?'سربراہِ ادارہ · Quran - Exa':locale==='ar'?'الرئيس التنفيذي · Quran - Exa':'Chief Executive Officer · Quran - Exa',
    ceoMessage:locale==='ur'?'ہم چاہتے ہیں کہ Quran - Exa بامقصد مطالعے کو آسان بنائے؛ ایک پُرسکون جگہ جہاں آپ قرآن پڑھ سکیں، سوچ سمجھ کر سوال کر سکیں اور اصل مآخذ کی طرف رجوع کر سکیں۔ نئی ٹیکنالوجی کو عاجزی اور احتیاط کے ساتھ فہم کی خدمت کرنی چاہیے۔ ہمارا عزم ہے کہ اصل متن کو مرکز میں رکھیں، حوالے واضح کریں اور جس بات کی تصدیق نہ کر سکیں اسے تسلیم کریں۔':locale==='ar'?'نريد أن يجعل Quran - Exa الدراسة الهادفة أكثر سهولة: مساحة هادئة لقراءة القرآن وطرح الأسئلة والرجوع إلى المصادر. يجب أن تخدم التقنية الفهم بتواضع وعناية، مع إبقاء النص الأصلي في المركز وإظهار المراجع بوضوح.':'We want Quran - Exa to make meaningful study easier: a calm space to read the Quran, ask thoughtful questions, and return to the sources. Technology should support understanding with humility and care. Our commitment is to keep the original text at the center, make references clear, and acknowledge what we cannot verify.'
